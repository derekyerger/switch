...
r="`xxd -p /dev/urandom -l 3 -c 3`"
uci set wireless.default_radio0.ssid="Vectis-$r"
uci set wireless.default_radio0.ssid_inbuilt="Vectis-$r"
uci set wireless.default_radio0.encryption=psk2
uci set wireless.default_radio0.key="vectisrocks"
uci set wireless.default_radio0.key_inbuilt="vectisrocks"

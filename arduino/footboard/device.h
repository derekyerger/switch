...
const char TDDESC2[] PROGMEM = "Soft pressure";
const char TDDESC3[] PROGMEM = "Contact time (in ms) considered a long press";
const char TDDESC4[] PROGMEM = "The time (in ms) between each sample";
const char TDDESC5[] PROGMEM = "Samples to continue reading before making a verdict";
const char TDDESC6[] PROGMEM = "After action, delay (in ms) before resuming sensing";
const char TDDESC7[] PROGMEM = "Past samples to include in the averaging function";
const char TDDESC8[] PROGMEM = "Keep soft and hard presses separated by this delta";
...
const char TDDESC14[] PROGMEM = "Seconds of inactivity before processor sleep";

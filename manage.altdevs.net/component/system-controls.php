...
<!--button type="button" class="btn btn-primary" onclick="retr('debug');">Debugging info</button-->
<button type="button" class="btn btn-primary" onclick="retr('update');">Update software from internet</button>
<button type="button" class="btn btn-primary" onclick="retr('reset');">Reboot</button>
...
<div class="modal fade" id="updateDlg" tabindex="-1" role="dialog" aria-labelledby="actionDlgLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
